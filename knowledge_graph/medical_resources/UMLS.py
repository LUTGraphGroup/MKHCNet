...
'''
Function: The main function is to load ICD related information from UMLS (Unified Medical Language System) data 
and find related terms (strings) based on ICD codes
'''
