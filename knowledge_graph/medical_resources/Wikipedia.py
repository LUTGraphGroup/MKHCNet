...
import re
'''
Function: It is used to obtain disease-related information from Wikipedia, including symptoms, signs,
 laboratory tests, drugs, treatments, causes, complications, risk factors and pathophysiology.
'''
